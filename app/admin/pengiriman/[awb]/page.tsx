...
export default async function AdminShipmentDetail({ params }: Props) {
  ...
  return <><SiteHeader userName={user.name || user.email} role={user.role} /><main id="main-content" className="app-main max-w-5xl space-y-6"><Link href="/admin" className="text-sm font-semibold text-primary underline-offset-4 hover:underline">← Pusat operasi</Link>
